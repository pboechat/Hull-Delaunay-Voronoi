...
namespace HullDelaunayVoronoi.Hull
{
    ...
    {
        internal int CONNECTOR_TABLE_SIZE
        {
            get
            {
                return 2017;
        ...
        internal List<VERTEX> InputVertices
        {
            get;
            private set;
        }
        
        internal List<SimplexWrap<VERTEX>> ConvexSimplexs
        {
            get;
            private set;
        }
        ...
        internal ObjectManager<VERTEX> ObjectManager
        {
            get;
            private set;
        }
        ...
        internal VERTEX FurthestVertex
        {
            get;
            set;
        }
        
        internal SimplexList<VERTEX> UnprocessedFaces
        {
            get;
            private set;
        }
        
        internal List<SimplexWrap<VERTEX>> AffectedFaceBuffer
        {
            get;
            private set;
        }
        
        internal Stack<SimplexWrap<VERTEX>> TraverseStack
        {
            get;
            private set;
        }
        
        internal HashSet<VERTEX> SingularVertices
        {
            get;
            private set;
        }
        
        internal List<DeferredSimplex<VERTEX>> ConeFaceBuffer
        {
            get;
            private set;
        }
        
        internal SimplexWrap<VERTEX>[] UpdateBuffer
        {
            get;
            private set;
        }
        
        internal int[] UpdateIndices
        {
            get;
            private set;
        }
        
        internal ConnectorList<VERTEX>[] ConnectorTable
        {
            get;
            private set;
        }
        
        internal VertexBuffer<VERTEX> EmptyBuffer
        {
            get;
            private set;
        }
        
        internal VertexBuffer<VERTEX> BeyondBuffer
        {
            get;
            set;
        }
