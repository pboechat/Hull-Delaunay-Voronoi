...
namespace HullDelaunayVoronoi.Hull
{
        ...
        where VERTEX : IVertex, new ()
    {
        ...
        /// </summary>
        internal SimplexWrap<VERTEX>[] AdjacentFaces
        {
            get;
            private set;
        }
        ...
        /// </summary>
        internal VertexBuffer<VERTEX> VerticesBeyond
        {
            get;
            set;
        }
        ...
        /// </summary>
        internal SimplexWrap<VERTEX> Previous
        {
            get;
            set;
        }
        ...
        /// </summary>
        internal SimplexWrap<VERTEX> Next
        {
            get;
            set;
        }
